...
- GROUP BY with aggregates: COUNT, COUNT(DISTINCT), SUM, AVG, MIN, MAX, VARIANCE, STDDEV, BOOL_AND, BOOL_OR, ANY_VALUE
...
- **Math**: ABS, ROUND, CEIL, FLOOR, SQRT, POWER, MOD, LOG, LN, LOG2, LOG10, EXP, SIGN, TRUNC, CBRT, PI, RANDOM
